    ...
    <div class="main-layout">
      ...
      <main class="content">
        ...
        <div class="kpi-strip">
          ...
          <div class="kpi-item">
            <div class="kpi-icon"
              :style="store.pendingEntities.length > 0 ? 'background:var(--color-warning-bg)' : 'background:var(--color-bg)'">
              <i class="ti ti-clock"
                :style="store.pendingEntities.length > 0 ? 'color:var(--color-warning)' : 'color:var(--color-text-muted)'"></i>
            </div>
            <div>
